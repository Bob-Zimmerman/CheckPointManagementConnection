...
enum CPMError: Error {
	static let unknownError = NSError(domain: CPMAPIErrorDomain, code: -1, userInfo: [
	...
	static let apiDown = NSError(domain: CPMAPIErrorDomain, code: -2, userInfo: [
	...
	static let badCredentials = NSError(domain: CPMAPIErrorDomain, code: -400, userInfo: [
	...
	static let connectionProhibited = NSError(domain: CPMAPIErrorDomain, code: -403, userInfo: [
	...
	static let tooManyRequests = NSError(domain: CPMAPIErrorDomain, code: -3, userInfo: [
	...
	static let writeCallInReadOnlySession = NSError(domain: CPMAPIErrorDomain, code: -4, userInfo: [
	...
	static let invalidObject = NSError(domain: CPMAPIErrorDomain, code: -5, userInfo: [
...
struct CPMLoginResponse: Codable, Identifiable {
